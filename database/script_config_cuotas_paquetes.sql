...
-- 1. AGREGAR COLUMNAS DE CONFIGURACIÓN DE CUOTAS Y FECHA LÍMITE DE PAGO INICIAL A PAQUETES GRUPALES
...
ADD COLUMN IF NOT EXISTS fecha_limite_cuota_inicial DATE;
